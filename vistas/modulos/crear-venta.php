        ...
        <div class="col-md-3" style="margin-top: 10px;">
           ...
           <div class="panel-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="fecha" data-date-format="dd-mm-yyyy" value="<?php echo $fecha; ?>">
                </div>
                ...
                <div class="col-xs-12" >
                  ...
                  <form accept-charset="utf-8" method="POST" name="frmBusqueda">
                    ...
                    <input type="text" class="form-control" name="busqueda" id="busqueda" value="" placeholder="" maxlength="30" autocomplete="off" onKeyUp="buscar();" />
                ...
                <div class="col-xs-12">
                  ...
                  <input type="text" class="form-control" id='nrocomprobante' name='nrocomprobante' value='<?php echo $registro;?>' autocomplete="off">
